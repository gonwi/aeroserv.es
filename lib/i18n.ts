...
export const dictionary = {
  es: {
    ...
    footer: {
      tagline: 'Servicios aeronáuticos y logística industrial para operaciones exigentes.',
      contactTitle: 'Contacto',
      legalTitle: 'Legal',
      addressLabel: 'Ubicación',
      phoneLabel: 'Teléfono',
      salesPhoneLabel: 'Comercial',
      emailLabel: 'Email',
  ...
  en: {
    ...
    footer: {
      tagline: 'Aeronautical services and industrial logistics for demanding operations.',
      contactTitle: 'Contact',
      legalTitle: 'Legal',
      addressLabel: 'Location',
      phoneLabel: 'Phone',
      salesPhoneLabel: 'Sales',
      emailLabel: 'Email',
...
export const clients = [
  ...
  { name: 'Aritex', src: '/client-logos/aritex.svg', width: 444, height: 134, href: 'https://aritex-es.com/' },
